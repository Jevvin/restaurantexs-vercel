// components/category/ClientComponents/HeaderClient.tsx
...
import HeaderServer from "@/components/category/ServerComponents/HeaderServer" // 👈 usa el HeaderServer de category
...
interface Props {
  ...
  title: string
  /** Markdown desde categories.description */
...
export default function HeaderClient({
  ...
  useEffect(() => {
    const desc = document.querySelector<HTMLElement>("[data-category-desc]") // 👈 coincide con HeaderServer (category)
    if (!desc) return
  ...
  }, [citySlug]) // si quieres que reaccione al slug de categoría también, añade aquí [citySlug, categoryName]
  ...
  return (
    <>
      <HeaderServer
        ...
        title={title}
        categoryDescription={categoryDescription} // 👈 viene de categories.description
